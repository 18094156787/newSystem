//
//  JCTeamMatchInfoTeamTableView.m
//  Jingcai
//
...
#import "JCTeamMatchInfoTeamTableViewCell.h"
#import "JCTeamDetailWMStickVC.h"
@implementation JCTeamMatchInfoTeamTableView
- (void)initViews {
    ...
    [self.tableView registerClass:[JCTeamMatchInfoTeamTableViewCell class] forCellReuseIdentifier:@"JCTeamMatchInfoTeamTableViewCell"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    JCTeamMatchInfoTeamTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"JCTeamMatchInfoTeamTableViewCell"];
