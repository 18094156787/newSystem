//
//  JCTeamMatchInfoTeamTableViewCell.m
//  Jingcai
//
...
@implementation JCTeamMatchInfoTeamTableViewCell
...
- (void)setModel:(JCEventScorePlayerModel *)model {
    _model = model;
    [self.teamImgView sd_setImageWithURL:[NSURL URLWithString:model.logo] placeholderImage:JCIMAGE(@"icon_qd_zq_default")];
