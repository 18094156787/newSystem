...
@property (nonatomic, strong) UILabel *away_zs_WinLab;

@property (nonatomic, strong) UILabel *away_zs_EqualLab;

@property (nonatomic, strong) UILabel *away_zs_LoseLab;

@property (nonatomic, strong) UILabel *away_fc_WinLab;

@property (nonatomic, strong) UILabel *away_fc_EqualLab;

@property (nonatomic, strong) UILabel *away_fc_LoseLab;
