...
- (instancetype)init {
    ...
    if (self = [super init]) {
        self.height = AUTO(300)+kNavigationBarHeight;
...
//    [self.navigationController.view addSubview:self.topColorView];
    ...
    UILabel *titleLab = [UILabel initWithTitle:@"离散指数" andFont:17 andWeight:3 andTextColor:COLOR_2F2F2F andBackgroundColor:JCClearColor andTextAlignment:NSTextAlignmentCenter];
