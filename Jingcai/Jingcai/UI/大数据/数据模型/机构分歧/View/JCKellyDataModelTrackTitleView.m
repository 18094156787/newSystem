...
- (UILabel *)plLab {
    if (!_plLab) {
        _plLab =[UILabel initWithTitle:@"胜/平/负" andFont:AUTO(12) andWeight:1 andTextColor:COLOR_9F9F9F andBackgroundColor:JCClearColor andTextAlignment:NSTextAlignmentCenter];
    }
    return _plLab;
}
...
- (UILabel *)klLab {
    if (!_klLab) {
        _klLab =[UILabel initWithTitle:@"机构分歧/方差" andFont:AUTO(12) andWeight:1 andTextColor:COLOR_9F9F9F andBackgroundColor:JCClearColor andTextAlignment:NSTextAlignmentCenter];
    }
    return _klLab;
}
