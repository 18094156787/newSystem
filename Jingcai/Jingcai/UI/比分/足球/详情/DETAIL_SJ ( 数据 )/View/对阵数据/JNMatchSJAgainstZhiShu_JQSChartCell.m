//
//  JNMatchSJAgainstZhiShu_JQSChartCell.m
//  Jingcai
//
...
@interface JNMatchSJAgainstZhiShu_JQSChartCell()

@property (nonatomic, strong) NSArray *titleArray;

@end

@implementation JNMatchSJAgainstZhiShu_JQSChartCell
...
- (void)initViews {
    ...
    [self.tableView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.height.mas_equalTo(AUTO(155));
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row==0) {
        cell.labelOne.text = self.productModel.jqs;
