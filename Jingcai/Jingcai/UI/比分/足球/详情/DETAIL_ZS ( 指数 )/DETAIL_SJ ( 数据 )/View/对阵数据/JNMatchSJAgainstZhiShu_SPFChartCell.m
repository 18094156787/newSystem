//
//  JNMatchSJAgainstZhiShu_SPFChartCell.m
//  Jingcai
//
...
@interface JNMatchSJAgainstZhiShu_SPFChartCell()

@property (nonatomic, strong) NSArray *titleArray;

@end

@implementation JNMatchSJAgainstZhiShu_SPFChartCell
...
- (void)initViews {
    ...
    UILabel *awayWinLab = [UILabel initWithTitle:@"客胜" andFont:AUTO(11) andWeight:1 andTextColor:COLOR_2F2F2F andBackgroundColor:JCClearColor andTextAlignment:0];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    JNMatchSJAgainstZhiShu_SPFChartContentCell *cell = [tableView dequeueReusableCellWithIdentifier:@"JNMatchSJAgainstZhiShu_SPFChartContentCell"];
