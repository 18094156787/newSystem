...
- (void)initViews {
    ...
    self.homeProgressView.layer.cornerRadius = AUTO(10);
    self.homeProgressView.layer.masksToBounds = YES;
    self.homeProgressView.frame = CGRectMake(AUTO(8), AUTO(30), SCREEN_WIDTH-AUTO(16), AUTO(20));
    ...
    [self.awayView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.right.equalTo(self.awayInfoLab.mas_left).offset(-2);
    ...
    [self.homeView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.right.equalTo(self.homeInfoLab.mas_left).offset(-2);
