//
//  JNMatchZS_JC_BF_InfoStyleFiveCell.m
//  Jingcai
//
...
@implementation JNMatchZS_JC_BF_InfoStyleFiveCell
...
- (void)initViews {
    ...
    NSArray *titleArray = @[@"2:4",@"0:5",@"1:5",@"2:5",@"负其他",@"",@"",@""];
...
- (void)setModel:(JNMatchBFBall *)model {
    ...
    [self.btnArray enumerateObjectsUsingBlock:^(JNMatchZS_JC_BF_ItemView *view, NSUInteger idx, BOOL * _Nonnull stop) {
        switch (view.tag) {
            case 100:
            {
                view.contentLab.text = model.s24;
            }
                break;
            case 101:
            {
                view.contentLab.text = model.s05;
            }
                break;
            case 102:
            {
                view.contentLab.text = model.s15;
            }
                break;
            case 103:
            {
                view.contentLab.text = model.s25;
            }
                break;
            case 104:
            {
                view.contentLab.text = model.sl;
            }
                break;
