//
//  JNMatchZS_JC_BCSPF_TableViewCell.m
//  Jingcai
//
...
@implementation JNMatchZS_JC_BCSPF_TableViewCell
...
- (void)initViews {
    ...
    [self.tableView registerClass:[JNMatchZS_JC_BCSPF_titleCell class] forCellReuseIdentifier:@"JNMatchZS_JC_BCSPF_titleCell"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.row==0) {
        JNMatchZS_JC_BCSPF_titleCell *cell = [tableView dequeueReusableCellWithIdentifier:@"JNMatchZS_JC_BCSPF_titleCell"];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    if (self.dataArray.count>0) {
        JNMatchBQCBall *model = self.dataArray.firstObject;
