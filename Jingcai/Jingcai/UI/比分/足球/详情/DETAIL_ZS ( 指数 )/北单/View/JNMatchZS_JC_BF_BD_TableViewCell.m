//
//  JNMatchZS_JC_BF_BD_TableViewCell.m
//  Jingcai
//
//  Created by 陈继伟 on 2020/12/11.
...
#import "JNMatchZS_JC_BF_BD_InfoStyleTwoCell.h"
#import "JNMatchZS_JC_BF_InfoStyleThreeCell.h"
#import "JNMatchZS_JC_BF_InfoStyleFourCell.h"
#import "JNMatchZS_JC_BF_BD_InfoStyleFiveCell.h"
#import "JNMatchBQCBall.h"
#import "JNMatchBFBall.h"
@implementation JNMatchZS_JC_BF_BD_TableViewCell
...
- (void)initViews {
    ...
    [self.tableView registerClass:[JNMatchZS_JC_BF_BD_InfoStyleTwoCell class] forCellReuseIdentifier:@"JNMatchZS_JC_BF_BD_InfoStyleTwoCell"];
    ...
    [self.tableView registerClass:[JNMatchZS_JC_BF_BD_InfoStyleFiveCell class] forCellReuseIdentifier:@"JNMatchZS_JC_BF_BD_InfoStyleFiveCell"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row==1) {
        JNMatchZS_JC_BF_BD_InfoStyleTwoCell *cell = [tableView dequeueReusableCellWithIdentifier:@"JNMatchZS_JC_BF_BD_InfoStyleTwoCell"];
        if (self.dataArray.count>0) {
            cell.model= self.dataArray.firstObject;
        }
        return cell;
    ...
    if (indexPath.row==4) {
        JNMatchZS_JC_BF_BD_InfoStyleFiveCell *cell = [tableView dequeueReusableCellWithIdentifier:@"JNMatchZS_JC_BF_BD_InfoStyleFiveCell"];
        if (self.dataArray.count>0) {
            cell.model= self.dataArray.firstObject;
        }
        return cell;
