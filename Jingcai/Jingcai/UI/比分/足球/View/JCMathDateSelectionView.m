...
//    self.bottomLineView.frame = CGRectMake(0, AUTO(42), AUTO(65), AUTO(2));
...
{
    JCMatchDateCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"JCMatchDateCell" forIndexPath:indexPath];
