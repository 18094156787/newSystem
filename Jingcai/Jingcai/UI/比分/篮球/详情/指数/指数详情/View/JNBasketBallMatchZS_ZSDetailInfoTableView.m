//
//  JNBasketBallMatchZS_ZSDetailInfoTableView.m
//  Jingcai
//
...
@implementation JNBasketBallMatchZS_ZSDetailInfoTableView
...
- (void)initViews {
    ...
    [self.tableView registerClass:[JNBasketBallMatchZS_ZSDetailInfoTableViewCell class] forCellReuseIdentifier:@"JNBasketBallMatchZS_ZSDetailInfoTableViewCell"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    JNBasketBallMatchZS_ZSDetailInfoTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"JNBasketBallMatchZS_ZSDetailInfoTableViewCell"];
    cell.type = self.type;
