...
@implementation JCBasketBallMatchZhiShuSFVC
...
//    self.tableView.scrollEnabled = NO;
    ...
    [self.tableView registerClass:[JNMatchZS_SF_TableViewCell class] forCellReuseIdentifier:@"JNMatchZS_SF_TableViewCell"];
    WeakSelf;
...
- (void)getDataList {
    [self loadDataWithMatchNum:self.matchBall.id type:@"3"];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    JNMatchZS_SF_TableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"JNMatchZS_SF_TableViewCell"];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    JNMatchZS_SF_HeadView *headView =  [JNMatchZS_SF_HeadView new];
