//
//  JCActivityGuess_SPF_More_MatchModel.h
//  Jingcai
//
...
@interface JCActivityGuess_SPF_More_MatchModel : JCWBaseBall
...
@property (nonatomic,strong) NSArray *activity_option_info;
...
@property (nonatomic,strong,nullable) UIButton *select_btn;//本地用来记录这场比赛的选项
