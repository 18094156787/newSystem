...
@implementation JCActivityKindScoreShowView
...
- (void)initViews {
    ...
    UILabel *titleLab = [UILabel initWithTitle:@"积分明细" andFont:AUTO(15) andWeight:2 andTextColor:COLOR_FB5835 andBackgroundColor:JCClearColor andTextAlignment:NSTextAlignmentCenter];
...
- (UITableView *)tableView {
    if (!_tableView) {
        ...
        //注册cell
        [view registerClass:[JCKindScoreItemCell class] forCellReuseIdentifier:@"JCKindScoreItemCell"];
