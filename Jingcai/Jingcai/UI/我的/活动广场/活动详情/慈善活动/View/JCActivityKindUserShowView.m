...
@implementation JCActivityKindUserShowView
...
- (void)initViews {
    ...
    UILabel *titleLab = [UILabel initWithTitle:@"活动完成用户" andFont:AUTO(15) andWeight:2 andTextColor:COLOR_FB5835 andBackgroundColor:JCClearColor andTextAlignment:NSTextAlignmentCenter];
...
- (UITableView *)tableView {
    if (!_tableView) {
        ...
        //注册cell
        [view registerClass:[JCKindCompleteUserCell class] forCellReuseIdentifier:@"JCKindCompleteUserCell"];
