//
//  JCActivityGuessChooseItemCell.m
//  Jingcai
//
...
@implementation JCActivityGuessChooseItemCell
...
- (void)setModel:(JCActivityOptionModel *)model {
    ...
    NSString *title = [NSString stringWithFormat:@"已有%ld人选择",model.count];
    NSMutableAttributedString *attributedStr = [[NSMutableAttributedString alloc] initWithString:title];
    NSRange range = [title rangeOfString:[NSString stringWithFormat:@"%ld",model.count]];
    if (range.location!=NSNotFound) {
        [attributedStr addAttributes:@{NSForegroundColorAttributeName:JCBaseColor} range:range];
    }
