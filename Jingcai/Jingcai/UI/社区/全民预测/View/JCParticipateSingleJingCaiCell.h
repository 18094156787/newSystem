//
//  JCParticipateSingleJingCaiCell.h
//  Jingcai
//
...
@interface JCParticipateSingleJingCaiCell : JCBaseTableViewCell_New
...
@property (nonatomic,copy) void(^JCJingcaiBlock)(NSMutableArray *btnArray);
