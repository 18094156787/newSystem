...
@interface JCYCRankViewController ()

@end

@implementation JCYCRankViewController
...
- (void)getDataList {
    ...
    [service getJingcaiRankList_ThisWeekWithpage:self.pageNo success:^(id  _Nullable object) {
        [self endRefresh];
