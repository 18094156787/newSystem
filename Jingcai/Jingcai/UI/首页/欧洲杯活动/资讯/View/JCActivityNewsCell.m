...
@implementation JCActivityNewsCell
...
- (void)setModel:(JCWNewsBall *)model {
    ...
    [self.iconImgView sd_setImageWithURL:[NSURL URLWithString:model.image.url] placeholderImage:nil];
...
- (UIImageView *)iconImgView {
    if (!_iconImgView) {
        ...
        [_iconImgView hg_setAllCornerWithCornerRadius:AUTO(4)];
    }
    return _iconImgView;
}
