...
@interface JCActivityFanganVC ()

@property (nonatomic,strong) NSString *type;//1 情报 2干货 3推荐
...
@implementation JCActivityFanganVC
...
- (void)getDataList {
    ...
    [service getPlanListWithPage:self.pageNo success:^(id  _Nullable object) {
        [self endRefresh];
