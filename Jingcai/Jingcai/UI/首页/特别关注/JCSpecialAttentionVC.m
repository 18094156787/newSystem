...
@interface JCSpecialAttentionVC ()
...
@implementation JCSpecialAttentionVC
...
- (void)getDataList {
    ...
    [service getConcernExpertTuiJianWithpage:self.pageNo success:^(id  _Nullable object) {
        [self endRefresh];
            ...
            if (self.pageNo==1) {
             ...
             for (NSDictionary *dic in array) {
                 if (dic[@"base_info"][@"type"]) {
                     NSString *type = dic[@"base_info"][@"type"];// 1公众号文章 2红榜方案
